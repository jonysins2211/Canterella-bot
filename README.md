...
• <b>Advanced Link Masking:</b> Hides shortener links using 5 crypto algorithms (AES-128, MD5, SHA-256, etc.)  
• <b>Bot & VPS Detection:</b> Blocks automated scripts, Selenium, and VPS/Datacenter IPs  
• <b>IP Security:</b> Rate limiting (15 req/min) and logging of all visitors to `ip_logs.txt`  
• <b>One-Time Links:</b> Auto-expire masked links after the first successful visit  
